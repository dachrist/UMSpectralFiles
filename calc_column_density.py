...
# Molecular masses
molmass = {'H':1.00784,'H2': 2.01588,'H2O':18.01528,'NH3':17.03052,'CH4':16.0425,'CO':28.0101,'CO2':44.0095,'He':4.0026020,'Na':22.989769280,'K':39.09830,'Li':6.9410,'Cs':132.90545190,'Rb':85.46780,'TiO':63.8664,'VO':66.94090,'HCN':27.0253}
...
def get_column_density(fname=None,
                       gravity=None,
                       species=['H2','He','H','H2O','CH4','CO','CO2','NH3','Na','K','Li','Rb','Cs','TiO','VO','HCN']):
